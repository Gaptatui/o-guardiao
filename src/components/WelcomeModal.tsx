        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 max-h-[200px] overflow-y-auto pr-2 custom-scrollbar">
            {[
              ...
              <div key={`welcome-step-${step.title.replace(/\s+/g, '-').toLowerCase()}`} className="flex gap-3 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800">
